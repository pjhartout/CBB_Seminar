...
\subtitle{Gibson \emph{et al} - seminar}
\date{\today}
...
\begin{frame}[fragile]{Motivation}
    ...
    \begin{aquote}{Gibson \emph{et al}}
  ...
  \begin{columns}[]
    ...
    \column{0.5\textwidth}
        \begin{figure}[b]
            ...
            \caption{Observed post-mitotic relationshipbetween daughter cells.}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=.25\textwidth]{figures/fig2a.png}
%     \caption{Discrete state dynamics}
%     
%   \end{figure}
%   \begin{figure}
%     \centering
%     \includegraphics[width=.5\textwidth]{figures/fig2c.png}
...
%   This article is from 2006, since then:
%   \begin{columns}
%     \column{0.5\textwidth}
%     Work on 3D structures:
%     \begin{figure}
%       \centering
%       \includegraphics[]{figures/scutoids.png}
%       \caption{The scutoid has been discovered as a solution to 3D cell packing}
%       
%     \end{figure}
%   \end{columns}
% \end{frame}
