  ...
  \begin{columns}
    ...
    \begin{table}
      ...
      \begin{tabular}{lp{12.5cm}}
        ...
        $P_{ij}$ & the probability that an $i$ sided cell divides to produce a $j$-sided daughter cell.\\
        $S_{ij}$ & the probability of an $i$-sided cell will gain sides from dividing neighbour cells divisions to become $j$-sided. \\
      \end{tabular}}
    \end{table}
  \end{columns}
\end{frame}
